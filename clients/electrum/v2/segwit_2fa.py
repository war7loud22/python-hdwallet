...
mnemonic: str = ElectrumV2Mnemonic.from_entropy(
    ...
    mnemonic_type=ELECTRUM_V2_MNEMONIC_TYPES.SEGWIT_2FA
)
electrum_v2_mnemonic: ElectrumV2Mnemonic = ElectrumV2Mnemonic(
    mnemonic=mnemonic, mnemonic_type=ELECTRUM_V2_MNEMONIC_TYPES.SEGWIT_2FA
)
...
seed: str = ElectrumV2Seed.from_mnemonic(
    mnemonic=electrum_v2_mnemonic, mnemonic_type=ELECTRUM_V2_MNEMONIC_TYPES.SEGWIT_2FA
)
