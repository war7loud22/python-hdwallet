...
def test_bip32_from_xpublic_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xpublic_key=data["hdwallet"]["BIP32"]["compressed"]["root_xpublic_key"],
...
def test_bip32_from_xpublic_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xpublic_key=data["hdwallet"]["BIP32"]["uncompressed"]["root_xpublic_key"],
