...
def test_bip32_from_public_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        public_key=data["hdwallet"]["BIP32"]["compressed"]["derivations"][-1]["public_key"]
    )
...
def test_bip32_from_public_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        public_key=data["hdwallet"]["BIP32"]["uncompressed"]["derivations"][-1]["public_key"]
    )
