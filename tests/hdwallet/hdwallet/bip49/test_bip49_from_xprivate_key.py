...
def test_bip49_from_xprivate_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["BIP49"]["compressed"]["root_xprivate_key"],
        strict=data["hdwallet"]["BIP49"]["compressed"]["strict"]
    ).from_derivation(
...
def test_bip49_from_xprivate_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["BIP49"]["uncompressed"]["root_xprivate_key"],
        strict=data["hdwallet"]["BIP49"]["uncompressed"]["strict"]
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["BIP49"]["derivation"]["name"])(
            **data["hdwallet"]["BIP49"]["derivation"]["args"]
        )
