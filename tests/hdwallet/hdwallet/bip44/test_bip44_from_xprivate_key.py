...
def test_bip44_from_xprivate_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["BIP44"]["compressed"]["root_xprivate_key"],
        strict=data["hdwallet"]["BIP44"]["compressed"]["strict"]
    ).from_derivation(
...
def test_bip44_from_xprivate_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["BIP44"]["uncompressed"]["root_xprivate_key"],
        strict=data["hdwallet"]["BIP44"]["uncompressed"]["strict"]
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["BIP44"]["derivation"]["name"])(
            **data["hdwallet"]["BIP44"]["derivation"]["args"]
        )
