...
def test_bip141_from_private_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        private_key=data["hdwallet"]["BIP141"]["compressed"]["derivations"][-1]["private_key"]
    )
...
def test_bip141_from_private_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        private_key=data["hdwallet"]["BIP141"]["uncompressed"]["derivations"][-1]["private_key"]
    )
